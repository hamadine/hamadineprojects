...
let motsComplet = [], mots = [], interfaceData = {}, indexMot = 0, fuse;
...
export function activerMicroEtComparer() {
...
export function rechercherDansHistoire(message) {
...
export function genererTraductions(motObj) {
...
export function afficherMessage(type, contenu) {
...
export function jouerAudio(path) {
  const audio = new Audio(path);
  audio.play().catch(() => alert("⚠️ Audio indisponible."));
}

export function initialiserMenusLangues() {
...
export function changerLangueInterface(code) {
